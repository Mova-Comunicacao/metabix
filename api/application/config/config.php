...
$config['sess_cookie_name'] = defined('APP_SESSION_COOKIE_NAME') ? APP_SESSION_COOKIE_NAME : 'ci_session';
$config['sess_expiration'] = defined('APP_SESSION_EXPIRATION') ? APP_SESSION_EXPIRATION : 7200;
...
$config['cookie_httponly']  = defined('APP_COOKIE_HTTPONLY') ? APP_COOKIE_HTTPONLY : TRUE;
